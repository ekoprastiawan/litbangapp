...
<html lang="en">
    ...
    <body>
        <table class="table display">
            <thead>
                <tr>
                    <th>Derived Period ID</th>
                    <th>Derived Period Name</th>
                    <th>Derived Period Group ID</th>
                    <th>Derived Period Group Name</th>
                </tr>
            </thead>
            <tbody>                
                @foreach($res1 as $res)
                <tr>
                    <td>{{$res['turth_id']}}</td>
                    <td>{{$res['turth']}}</td>
                    <td>{{$res['group_turth_id']}}</td>
                    <td>{{$res['name_group_turth']}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
