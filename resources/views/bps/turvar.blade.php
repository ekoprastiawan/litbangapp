...
<html lang="en">
    ...
    <body>
        <table class="table display">
            <thead>
                <tr>
                    <th>Derived Variable ID</th>
                    <th>Derived Variable Name</th>
                    <th>Derived Variable Group ID</th>
                    <th>Derived Variable Group Name</th>
                </tr>
            </thead>
            <tbody>                
                @foreach($res1 as $res)
                <tr>
                    <td>{{$res['turvar_id']}}</td>
                    <td>{{$res['turvar']}}</td>
                    <td>{{$res['group_turvar_id']}}</td>
                    <td>{{$res['name_group_turvar']}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
